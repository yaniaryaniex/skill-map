...
from skill_map.cli import main
from skill_map.models import Note, ProjectState, Task
from skill_map.cli import demo_state
from skill_map.storage import load_state, save_state
from skill_map.models import generate_short_id
from skill_map.validation import normalize_tags, require_text, validate_task_status
from skill_map.services import (
    create_note,
    list_notes,
    get_note,
    update_note,
